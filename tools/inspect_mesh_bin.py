...
def main() -> None:
    ...
    has_blendweights = version >= 8 and (flags & 128) == 128
    has_blendindices = version >= 8 and (flags & 256) == 256
    ...
    print("hasBlendWeights:", has_blendweights)
    print("hasBlendIndices:", has_blendindices)
