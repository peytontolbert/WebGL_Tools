#!/usr/bin/env python3
"""
Z-Image-Turbo (text -> image) quick test script.

Example:
  conda activate trellis
  python3 tools/zimage_text_to_image.py \
    --prompt "Young Chinese woman in red Hanfu..." \
    --out outputs/zimage.png \
...
def _parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(prog="tools/zimage_text_to_image.py")
