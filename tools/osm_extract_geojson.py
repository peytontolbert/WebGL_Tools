...
def main(argv: list[str]) -> int:
    ...
    ap.add_argument("--overwrite", action="store_true", help="Overwrite existing output .geojson files")
    ...
    with tempfile.TemporaryDirectory(prefix="osmgeojson_") as td:
        ...
        _run([osmium, "export", "-f", "geojson", "-o", out_highways, *ow, highways_pbf])
        _run([osmium, "export", "-f", "geojson", "-o", out_buildings, *ow, buildings_pbf])
